#  C - Binary  Trees
This is a project in C where we learnt about what Binary Trees and Binary Search Trees are, the advantage and disadvantages of using them. We learned about how to qualify trees as well as how to traverse them. Throughout the project, we implemented binary, binary search, AVL, and Max Binary Heap trees.
